...
\iulproductname{Изделие {\productcipher}\\Специальное программное обеспечение ПТУ\\Программный комплекс\\Галактический транклюкатор}
\iulmdfive{1234.5678.9012.3456}
\iulversion{111}
...
\title{Изделие {\productcipher}\\Специальное программное обеспечение ПТУ\\Программный комплекс\\Галактический транклюкатор} 
...
\maketitle % Титульник
\input{document/аннотация}
\tableofcontents % Содержание
%%%% Дальше пошли разделы
\input{document/оформление_разделов} 
\input{document/оформление_перечислений} 
\input{document/оформление_иллюстраций} 
\input{document/оформление_формул} 
\input{document/оформление_таблиц} 
\input{document/оформление_листингов}
\iulist % Информационно-удостоверяющий лист
\bibliography{bibliography}
\input{document/термины}
\input{document/аббревиатуры}
\input{document/приложение_1}
\input{document/приложение_2}
%
\registrationnew
}
\end{document}
