\newpage\attachment{Обязательное}{Пример приложения с номером и без разделов}
...
\illustration[][Тестовое изображение <<Лена>>][0.2]{Lenna}[img:приложение1-лена1]
\illustration[][Тестовое изображение <<Лена>>][0.2]{Lenna}[img:приложение1-лена2]
